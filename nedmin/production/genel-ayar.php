        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="../netting/adminislem.php" method="post" enctype="multipart/form-data" id="demo-form2" ata-parsley-validate class="form-horizontal form-label-left">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <img src="../../dimg/resim_yok.png" width="200" >
                            ...
                            <input type="hidden" name="eski_yol" value="<?php $ayarcek['ayar_logo']; ?>">
                            <div class="ln_solid"></div>
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="logoduzenle" class="btn btn-success">Yükle</button>
                                </div>
                            </div>
                        </form>
                        <hr>                
