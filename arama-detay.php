                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                <div class="page-controls-sorting">
                                    <div class="dropdown">
                                        <!-- <button class="btn sorting-btn dropdown-toggle" type="button" data-toggle="dropdown">Sıralama<i class="fa fa-sort" aria-hidden="true"></i></button>
                                        <ul class="dropdown-menu">
                                            <li><a href="#">En çok satan</a></li>
                                            <li><a href="#">En beğenilen</a></li>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active clear products-container" id="list-view">
                            <div class="product-list-view">
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    $sorgu->execute(array("%$searchkeyword%"));
                                    ...
                                    if ($say == 0) {
                                        echo "Aradığınız anahtar kelimeye uygun ürün bulunamadı";
                                    }
                                }
                                            ...
                                            <div class="item-profile">
                                                <div class="profile-title">
                                                    <div class="img-wrapper">
                                                        <img src="<?php echo $uruncek['kullanici_magazafoto']; ?>" alt="profile" class="img-responsive img-circle">
                                                    </div>
                                                    <span>
                                                        <?php
                                                        $ad = $uruncek['kullanici_ad'];
                                                        $dizi = explode(" ", $ad);

                                                        echo $dizi[0] . " " . substr($uruncek['kullanici_soyad'], 0, 1)
                                                        ?>.</span>
                                                </div>
